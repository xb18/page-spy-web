...
import whyIsPageSpyImg from '@/assets/image/screenshot/pagespy-zh.png';
import onlineMode from '@/assets/image/screenshot/online-mode-zh.png';
import offlineMode from '@/assets/image/screenshot/offline-mode-zh.png';
